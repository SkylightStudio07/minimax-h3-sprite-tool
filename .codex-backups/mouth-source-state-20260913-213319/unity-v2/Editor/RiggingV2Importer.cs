...
namespace SpriteLab.RiggingV2.Editor
{
    public static class RiggingV2Importer
    {
        ...
        [Serializable] private sealed class Manifest { public CanvasInfo canvas; public Part[] parts; public Expression[] expressions; }
        ...
        private static string BuildPrefab(string assetRoot, Manifest manifest, RigData rig)
        {
            ...
            for (var i = 0; i < manifest.parts.Length; i++)
            {
                ...
                var renderer = CreateLayer(root.transform, assetRoot, part, i, manifest.canvas);
            ...
            for (var i = 0; i < expressions.Length; i++)
            {
                ...
                var renderer = CreateLayer(root.transform, assetRoot, expression, 1000 + i, manifest.canvas);
